...
// тема письма
$subject = 'Письмо с моего сайта от ' . $_POST['dfname1'];
...
$message = 'Имя: ' . $_POST['dfname1'] . '<br />' . 'Аккаунт: ' . $_POST['dfname2'] . '<br />' . 'Телефон: ' . $_POST['dfname3'] . '<br />' . 'Почта: ' . $_POST['dfname4'] . '<br />' . '<br />' .'Сообщение: ' . $messageInp;
