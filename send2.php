...
// тема письма
$subject = 'Письмо с моего сайта. Тариф - Ведение под ключ от'  . $_POST['dfname1'];
...
$message = 'Тариф - Ведение под ключ.' . '<br />' . 'Имя: ' . $_POST['dfname1'] . '<br />' . 'Аккаунт: ' . $_POST['dfname2'] . '<br />' . 'Телефон: ' . $_POST['dfname3'] . '<br />' . 'Почта: ' . $_POST['dfname4'] . '<br />' . '<br />' . 'Сообщение: ' . $messageInp;
